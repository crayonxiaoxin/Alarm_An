 ...
 */
abstract class BaseListAdapterS<ItemBean, ItemBinding : ViewDataBinding>(diff: DiffUtil.ItemCallback<ItemBean>) :
    ListAdapter<ItemBean, BaseListAdapterS<ItemBean, ItemBinding>.ViewHolder>(diff) {
